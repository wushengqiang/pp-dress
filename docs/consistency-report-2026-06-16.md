...
- `TOTAL_DAYS` remains `7` across progression, main menu/goodnight UI, daily scene, dialogue UI, light narrative dialogue, clothing unlock, and Save/Load boundary notes.
...
- Wardrobe category keys remain consistent: `top`, `bottom`, `shoes`, `accessory`, `hair`, `makeup`.
...
- The 2026-06-16 updates to `input-management.md`, `save-load.md`, and `systems-index.md` did not introduce registry-value conflicts.
